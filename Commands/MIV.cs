...
namespace OzoneOS
{
    public class MIV : Command
    {
        ...
        public override string execute(string[] args)
        {
            ...
            String stringCopy(String value)
            {
            ...
            void printMIVScreen(char[] chars, int pos, String infoBar, Boolean editMode)
            {
                int countNewLine = 0;
                int countChars = 0;
                delay(10000000);
            ...
            bool isForbiddenKey(ConsoleKey key)
            {
